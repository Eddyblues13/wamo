                ...
                <tbody class="divide-y divide-white/5">
                    @forelse ($requests as $r)
                        <tr class="transition hover:bg-white/5">
                            ...
                            <td class="px-6 py-4">{{ $r->method_label }}</td>
                            <td class="px-6 py-4 text-right font-semibold tabular-nums">${{ number_format((float) $r->amount, 2) }}</td>
                            <td class="hidden px-6 py-4 text-white/55 md:table-cell">
