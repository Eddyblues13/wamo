...
<body style="margin:0;background:#0b0f1a;font-family:Helvetica,Arial,sans-serif;color:#e8ecf5;">
    <div style="max-width:480px;margin:0 auto;padding:40px 24px;">
        <div style="text-align:center;margin-bottom:28px;">
            <span style="display:inline-block;font-size:22px;font-weight:800;color:#ffffff;">Fintriva</span><span style="font-size:22px;font-weight:800;color:#8ab4ff;"> International</span>
        </div>
        ...
        <div style="background:#121726;border:1px solid #232a3d;border-radius:20px;padding:32px;text-align:center;">
            ...
            <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#9aa4bd;">
                Hi {{ $name }}, use the code below to confirm your email address and activate your Fintriva account.
            </p>
        ...
        <p style="text-align:center;margin:24px 0 0;font-size:12px;color:#5f6982;">
            © {{ date('Y') }} Fintriva International. Investing involves risk. Capital at risk.
        </p>
    </div>
</body>
</html>
